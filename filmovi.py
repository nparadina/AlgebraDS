...
print(df.corr().abs().sort_values('vote_count', ascending=False).drop('vote_count'))
# print(df.vote_count.corr(method='pearson'))
df.vote_count[df.vote_count<3000].plot.box()
plt.show()
df.vote_count.plot.hist()
plt.show()
df.vote_count[df.vote_count<3000].plot.hist()
plt.show()